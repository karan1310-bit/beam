...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // ✅ Use singleton instance to avoid duplicate client errors
      ...
      <StatusCard
        ...
        action={
          <button
            ...
            className="w-full max-w-xs bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
          >
            Retry
          </button>
        }
